/* AttansicL2Ethernet.cpp -- atl2 driver functions
 *
...
OSDefineMetaClassAndStructors(AttansicL2Ethernet, IOEthernetController)

#pragma mark -
#pragma mark - IOService overrides -
#pragma mark -

bool AttansicL2Ethernet::init(OSDictionary *properties)
{
	DbgPrint("init()\n");
...
bool AttansicL2Ethernet::start(IOService *provider)
{
	DbgPrint("start()\n");
	...
	if (msi_index != -1)
	{
		...
		intSource_ = IOInterruptEventSource::interruptEventSource(this,
					OSMemberFunctionCast(IOInterruptEventSource::Action, this, &AttansicL2Ethernet::atIntr),
...
void AttansicL2Ethernet::stop(IOService *provider)
{
	DbgPrint("stop()\n");
...
bool AttansicL2Ethernet::OSAddNetworkMedium(UInt32 type, UInt32 bps, UInt32 index)
{
...
IOOutputQueue *AttansicL2Ethernet::createOutputQueue()
{
 ...
 **/
void AttansicL2Ethernet::at_intr_tx(at_adapter *adapter)
{
    u32 txd_read_ptr;
    u32 txs_write_ptr;
    tx_pkt_status_t* txs;
...
const OSString *AttansicL2Ethernet::newVendorString() const
{
	return OSString::withCString("Attansic");
}

const OSString *AttansicL2Ethernet::newModelString() const
{
...
IOReturn AttansicL2Ethernet::getHardwareAddress(IOEthernetAddress *addr)
{
...
IOReturn AttansicL2Ethernet::setHardwareAddress(const IOEthernetAddress *addr)
{
...
void AttansicL2Ethernet::getPacketBufferConstraints(IOPacketBufferConstraints *constraints) const
{
...
IOReturn AttansicL2Ethernet::registerWithPolicyMaker(IOService *policyMaker)
{
...
IOReturn AttansicL2Ethernet::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker)
{
 ...
 **/
IOReturn AttansicL2Ethernet::setPromiscuousMode(bool enabled)
{
 ...
 * promiscuous mode, and all-multi behavior.
 **/
IOReturn AttansicL2Ethernet::setMulticastMode(bool enabled)
{
...
IOReturn AttansicL2Ethernet::setMulticastList(IOEthernetAddress *addrs, UInt32 count)
{
...
int AttansicL2Ethernet::mdio_read(int phy_id, int reg_num)
{
	u16 result;
...
void AttansicL2Ethernet::mdio_write(int phy_id, int reg_num, int val)
{
 ...
 **/
bool AttansicL2Ethernet::atProbe()
{
...
#pragma mark -
#pragma mark - Attansic L2 Hw methods
#pragma mark -
 ...
 */
SInt32 AttansicL2Ethernet::atSetupLink()
{
	SInt32 ret_val;
