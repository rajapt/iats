...
struct atl1c_hw {
	...
	atl1c_nic_type  nic_type;
	atl1c_dma_order dma_order;
	atl1c_dma_rcb   rcb_value;
	atl1c_dma_req_block dmar_block;
	atl1c_dma_req_block dmaw_block;
...
#define ATL1C_WORK_EVENT_LINK_CHANGE    0x02
	...
	atl1c_ring_header ring_header;
	atl1c_tpd_ring tpd_ring[AT_MAX_TRANSMIT_QUEUE];
	atl1c_rfd_ring rfd_ring[AT_MAX_RECEIVE_QUEUE];
	atl1c_rrd_ring rrd_ring[AT_MAX_RECEIVE_QUEUE];
	atl1c_cmb cmb;
	atl1c_smb smb;
	int num_rx_queues;
