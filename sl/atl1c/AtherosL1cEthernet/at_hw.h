...
//int atl1c_phy_commit(atl1c_hw *hw);
int atl1c_get_speed_and_duplex(atl1c_hw *hw, u16 *speed, u16 *duplex);
u32 atl1c_auto_get_fc(atl1c_adapter *adapter, u16 duplex);
...
int atl1c_validate_mdi_setting(atl1c_hw *hw);
void atl1c_hw_set_mac_addr(atl1c_hw *hw);
...
void atl1c_force_ps(atl1c_hw *hw);
int atl1c_restart_autoneg(atl1c_hw *hw);
