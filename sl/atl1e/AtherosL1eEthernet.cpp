/* AtherosL1eEthernet.h -- ATL1e driver implements
 *
...
OSDefineMetaClassAndStructors(AtherosL1eEthernet, IOEthernetController)

#pragma mark -
#pragma mark - IOService overrides -
#pragma mark -

bool AtherosL1eEthernet::init(OSDictionary *properties)
{
	DbgPrint("init()\n");
...
bool AtherosL1eEthernet::start(IOService *provider)
{
	DbgPrint("start()\n");
	...
	if (msi_index != -1)
	{
		...
		intSource_ = IOInterruptEventSource::interruptEventSource(this,
					OSMemberFunctionCast(IOInterruptEventSource::Action, this, &AtherosL1eEthernet::atIntr),
...
void AtherosL1eEthernet::stop(IOService *provider)
{
	DbgPrint("stop()\n");
...
bool AtherosL1eEthernet::OSAddNetworkMedium(UInt32 type, UInt32 bps, UInt32 index)
{
...
IOOutputQueue *AtherosL1eEthernet::createOutputQueue()
{
 ...
 **/
void AtherosL1eEthernet::atIntr(OSObject *client, IOInterruptEventSource *src, int count)
{
    at_adapter *adapter = &adapter_;
    at_hw *hw = &adapter->hw;
    u32 status;
...
bool AtherosL1eEthernet::at_clean_tx_irq(at_adapter* adapter)
{ 
...
void AtherosL1eEthernet::at_clean_rx_irq(at_adapter *adapter, u8 que)
{
    mbuf_t skb = NULL;
...
IOReturn AtherosL1eEthernet::enable(IONetworkInterface *netif)
{
	DbgPrint("enable()\n");
...
IOReturn AtherosL1eEthernet::disable(IONetworkInterface *netif)
{
	DbgPrint("disable()\n");
	at_adapter *adapter=&adapter_;
...
bool AtherosL1eEthernet::configureInterface(IONetworkInterface *netif)
{
...
const OSString *AtherosL1eEthernet::newVendorString() const
{
	return OSString::withCString("Atheros");
}

const OSString *AtherosL1eEthernet::newModelString() const
{
	return OSString::withCString("L1e LAN");
}

IOReturn AtherosL1eEthernet::selectMedium(const IONetworkMedium *medium)
{
...
IOReturn AtherosL1eEthernet::getHardwareAddress(IOEthernetAddress *addr)
{
...
IOReturn AtherosL1eEthernet::setHardwareAddress(const IOEthernetAddress *addr)
{
...
void AtherosL1eEthernet::getPacketBufferConstraints(IOPacketBufferConstraints *constraints) const
{
...
UInt32 AtherosL1eEthernet::outputPacket(mbuf_t m, void *prm)
{
	UInt32 buf_len;
	at_adapter *adapter=&adapter_;
...
IOReturn AtherosL1eEthernet::registerWithPolicyMaker(IOService *policyMaker)
{
...
IOReturn AtherosL1eEthernet::setPowerState(unsigned long powerStateOrdinal, IOService *policyMaker)
{
 ...
 **/
IOReturn AtherosL1eEthernet::setPromiscuousMode(bool enabled)
{
 ...
 * promiscuous mode, and all-multi behavior.
 **/
IOReturn AtherosL1eEthernet::setMulticastMode(bool enabled)
{
...
IOReturn AtherosL1eEthernet::setMulticastList(IOEthernetAddress *addrs, UInt32 count)
{
...
int AtherosL1eEthernet::mdio_read(int phy_id, int reg_num)
{
	UInt16 result;
...
void AtherosL1eEthernet::mdio_write(int phy_id, int reg_num, int val)
{
 ...
 **/
bool AtherosL1eEthernet::atProbe()
{
...
void AtherosL1eEthernet::atSwFree()
{
...
void AtherosL1eEthernet::atGetAndUpdateLinkStatus()
{
        UInt16 speed, duplex;
 ...
 */
SInt32 AtherosL1eEthernet::atSetupLink()
{
	SInt32 ret_val;
