...
sudo chown -R root:wheel  /System/Library/Extensions/AtherosL2Ethernet.kext
...
sudo kextunload  /System/Library/Extensions/AtherosL2Ethernet.kext
sudo rm -R /System/Library/Extensions/AtherosL2Ethernet.kext
